// places.js
// Combined list of all unique matcha places for use in both Explore and Map sections

window.places = [
  {
    name: "Sorate Matcha",
    address: "103 Sullivan St, New York, NY 10012",
  ...
  {
    name: "Lille Petra",
    address: "Kronprinsessegade 4, 1306 København, Denmark",
    location: "Copenhagen",
